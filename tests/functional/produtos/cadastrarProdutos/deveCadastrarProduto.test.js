...
describe('Produtos - Post', async () => {
	...
	before('Deve realizar o cadastro de um administrador e realizar login', async () => {
		userAdm = await postUsuarios({nome: TC070.usuario.name, email: TC070.usuario.email, password: TC070.usuario.password, administrador: TC070.usuario.administrador})
